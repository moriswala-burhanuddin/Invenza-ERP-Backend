...
# Email Settings
EMAIL_BACKEND = os.environ.get('EMAIL_BACKEND', 'backend_core.email_backend.UnverifiedEmailBackend')
...
_admin_email = os.environ.get('ADMIN_EMAIL', os.environ.get('EMAIL_HOST_USER'))
